...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<title><g:layoutTitle default="Digital Creativity Contest"/></title>
...
<%--		<div id="grailsLogo" role="banner"><a href="http://grails.org"><img src="${resource(dir: 'images', file: 'grails_logo.png')}" alt="Grails"/></a></div>--%>
		<g:layoutBody/>
		<div class="footer" role="contentinfo"> &copy; FOO BAR, INC &nbsp;&nbsp; 123 E. 8TH STREET &nbsp;&nbsp; DIGIVILLE, SOUTH IOWA 50001 &nbsp;&nbsp; 555.555.1234</div>
		<r:layoutResources />
	</body>
</html>