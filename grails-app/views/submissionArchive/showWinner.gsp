	...
	<body>
		...
		<div id="show-submissionArchive" class="content scaffold-show" role="main">
			...
			<ol class="property-list submissionArchive">
				...
				<g:if test="${submissionArchiveInstance?.emailAddr}">
				<li class="fieldcontain">
					<span id="emailAddr-label" class="property-label"><g:message code="submissionArchive.emailAddr.label" default="Email" /></span>
					
						<span class="property-value" aria-labelledby="emailAddr-label"><g:fieldValue bean="${submissionArchiveInstance}" field="emailAddr"/></span>
				...
				<li class="fieldcontain">
					...
					<span class="property-value" aria-labelledby="link-label"><a href="" onclick="showSubmission('${submissionArchiveInstance.link}');"><g:fieldValue bean="${submissionArchiveInstance}" field="link"/></a></span>
				</li>
				</g:if>
